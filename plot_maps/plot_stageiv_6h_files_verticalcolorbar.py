...
for i, loc in enumerate(grid_locs):
	...
	cbar = plt.colorbar(im, ax=ax, extend='max', ticks=precip_levels, orientation='vertical', pad=0.01, fraction=0.061, shrink=0.95) # fraction is height, shrink is width
	...
	cbar.ax.set_yticklabels([f'{l:g}' for l in precip_levels])    
