...
plt.tight_layout()
plt.savefig(f"{MAP_PATH}/{grid}/{var}/aigfs_{duration}h{var}_init{pdy}_{cyc}Z_f{fhr}_valid{valid_dt.strftime('%Y%m%d')}_{valid_dt.strftime('%H')}Z.png", bbox_inches='tight', pad_inches=0.1)
