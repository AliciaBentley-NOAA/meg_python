...
with grib2io.open(filename_gfs) as f_gfs:
	...
	weasd_msg = f_gfs.select(shortName='SNOD', level='surface')[0]

	# Extract values
	weasd_data = weasd_msg.data * 39.3701  # Convert meters to inches
