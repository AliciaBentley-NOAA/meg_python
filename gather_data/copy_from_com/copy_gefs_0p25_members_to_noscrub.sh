...
for h in $(seq 0 12 24); do
    ...
    for member in $(seq 0 1 30); do
        if [ "$member" -eq 0 ]; then
            ...
            printf -v mem_name "gep%02d" "$member"
        fi   
 
        # Construct the filename
        FILE="${mem_name}.t${HH}z.pgrb2s.0p25.f${HHH}"
...
echo "=========================================================="
echo " All GEFS members and cycles (00, 12) have been processed."
echo "=========================================================="
