...
SOURCE_DIR="/lfs/h1/ops/prod/dcom/${YYYYMMDD}/wgrbbul/ecmwf_aifs"
DEST_DIR="/lfs/h2/emc/vpppg/noscrub/alicia.bentley/alb_flood/ecmwf_aifs.${YYYYMMDD}/${HH}/atmos"
...
for h in $(seq 0 6 246); do
    ...
    FILE=${YYYYMMDD}${HH}"0000-"${h}"h-oper-fc.grib2"
...
echo "=========================================================="
echo " All ECMWF AIFS cycles (00, 12) have been processed."
echo "=========================================================="
