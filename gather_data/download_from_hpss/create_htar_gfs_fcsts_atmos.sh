...
mkdir -p ${DATA_PATH}/gfs.${YYYYMMDD}/${HH}/atmos
...
while IFS= read -r line ; do
	...
	if [[ -s ${DATA_PATH}/gfs.${YYYYMMDD}/${HH}/atmos/gfs.t${HH}z.pgrb2.0p25.f${FHHH_same} ]] ; then
		echo ${CYCLE} "F"${FHHH_same}" GFS forecast already exists"
        	...
        	sleep 3
        	mv $GFS_FILENAME ${DATA_PATH}/gfs.${YYYYMMDD}/${HH}/atmos/gfs.t${HH}z.pgrb2.0p25.f${FHHH_same}
	fi
